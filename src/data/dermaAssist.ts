...
export const dermaAssist: CaseStudy = {
  ...
  lenses: {
    backend: {
      ...
      frame:
        "The agent server: perceive → reason → act → verify, streamed as seven event types. Safety that matters is deterministic JSON, not a prompt. No LangChain. The Space is one Docker image.",
  ...
  problem: [
    "Ask a chatbot for a skincare routine and it guesses. It doesn’t know your country, your tretinoin, or your budget, and it will still name products. That’s a language model completing a sentence, not an agent doing a job.",
